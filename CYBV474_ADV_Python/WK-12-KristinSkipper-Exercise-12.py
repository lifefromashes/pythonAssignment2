...
def main():
    ...
    # Now test the model using the dfTest dataframe
    ...
    for row in dfTest.itertuples():
        ...
        encoded_test_sentiments = le.transform(dfTest['Sentiment'])
        print("KNeighbors accuracy score:", accuracy_score(encoded_test_sentiments, predicted_sentiments))
