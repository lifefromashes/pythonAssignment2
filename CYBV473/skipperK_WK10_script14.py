...
# Display the codebook for user to choose
print("Codebook:")
...
try:
    ...
    for message_index, (c, r) in zip(messages, pixels_to_hide):
        ...
        # Use bitwise to use binary number to set or clear least significant bit.
    ...
    new_img.save('skipper_covert_image.bmp')
